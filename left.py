...
left_comp_ip = '192.168.0.225'
middle_comp_ip = '192.168.0.225'
right_comp_ip = '192.168.0.225'
...
RIGHT_PAD: int = c.create_line(WIDTH - RIGHT_PAD_W / 2, 0, WIDTH - RIGHT_PAD_W / 2,
